...
export default function NewProductPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] px-4 md:px-16 py-8 md:py-10">
      <h1 className="font-display text-2xl md:text-4xl text-[#2B2420] mb-6 md:mb-8">Add a new product</h1>
      ...
      <form onSubmit={handleSubmit} className="max-w-xl flex flex-col gap-5">
        ...
        <button
          type="submit"
          disabled={submitting}
          className="bg-[#8C4A3A] hover:bg-[#7a3f31] disabled:opacity-60 text-white font-medium py-3 rounded-lg transition-colors text-sm tracking-wide"
        >
