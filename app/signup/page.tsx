  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] flex flex-col md:flex-row items-center justify-center px-6 md:px-16 gap-10 md:gap-16 py-10">
      ...
      <div className="w-full max-w-md">
        <h1 className="font-display text-3xl md:text-4xl text-[#2B2420] mb-6 text-center">
          Create your account
        </h1>
        ...
        <form onSubmit={handleSignup} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="flex-1">
              <label className="block text-sm text-[#2B2420] mb-1.5">First Name</label>
              <input
                type="text"
            ...
            <div className="flex-1">
              <label className="block text-sm text-[#2B2420] mb-1.5">Last Name</label>
              <input
                type="text"
          ...
          {/* Password */}
          <div>
            <label className="block text-sm text-[#2B2420] mb-1.5">Password</label>
            <input
              type="password"
              placeholder="••••••••"
              value={password}
          ...
          {/* Confirm Password */}
          <div>
            <label className="block text-sm text-[#2B2420] mb-1.5">Confirm Password</label>
            <input
              type="password"
              placeholder="••••••••"
              value={confirm}
          ...
          <label className="flex items-start gap-2.5 cursor-pointer mt-1">
            <input
              ...
              className="mt-0.5 accent-[#8C4A3A] w-4 h-4 cursor-pointer flex-shrink-0"
            />
            <span className="text-xs text-[#6b5c52] leading-relaxed">
              I agree with the{" "}
              <button type="button" className="underline hover:text-[#8C4A3A]">Terms of Service</button>
              {" "}and{" "}
              <button type="button" className="underline hover:text-[#8C4A3A]">Privacy Policy</button>
            </span>
          </label>
        ...
        <div className="flex items-center gap-3 my-5">
          ...
          <span className="text-xs text-[#8A7F76]">OR Sign up with</span>
          <div className="flex-1 h-px bg-[#E7DDD4]" />
        </div>
